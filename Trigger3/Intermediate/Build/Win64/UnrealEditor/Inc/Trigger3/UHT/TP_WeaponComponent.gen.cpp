...
#include "Trigger3/TP_WeaponComponent.h"
...
// Cross Module References
	...
	TRIGGER3_API UClass* Z_Construct_UClass_UTP_WeaponComponent();
	TRIGGER3_API UClass* Z_Construct_UClass_UTP_WeaponComponent_NoRegister();
...
// End Cross Module References
	...
	{
		P_GET_OBJECT(ATrigger3Character,Z_Param_TargetCharacter);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	struct Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon_Statics
	{
		...
		{
			ATrigger3Character* TargetCharacter;
		};
	...
	template<> TRIGGER3_API UClass* StaticClass<UTP_WeaponComponent>()
	{
		return UTP_WeaponComponent::StaticClass();
	}
